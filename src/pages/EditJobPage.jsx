...
const EditJobPage = ({ updateJobSubmit }) => {
    ...
    const [companyName, setCompanyName] = React.useState(job.company.name);
    const [companyDescription, setCompanyDescription] = React.useState(job.company.description);
    const [contactEmail, setContactEmail] = React.useState(job.company.contacEmail);
    const [contactPhone, setContactPhone] = React.useState(job.company.contactPhone);
